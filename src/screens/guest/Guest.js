            ...
            {isLoading ? <LoadingScreen/> : 
                <div className='container'>
                    <div className='center'>
                        ...
                        <Button type='button' category='cta' fontType='bold' fontSize={'11px'} text='Check out' /> 
                    </div>
...
const mapDispatchToProps = {setGuest, setIsLoading, setDives, setCourses, setRetail, setRentals, setModalVisibility};
